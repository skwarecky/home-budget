				...
				<div class="flex items-center gap-4">
					<div class="sm:flex sm:gap-4">
						...
						<Link :href="route('login')"
							  class="block rounded-md bg-teal-600 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-teal-700">Log in</Link>


						<Link :href="route('register')"
							  class="hidden rounded-md bg-gray-100 px-5 py-2.5 text-sm font-medium text-teal-600 transition hover:text-teal-600/75 sm:block">Register</Link>
