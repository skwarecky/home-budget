...
const form = useForm({
	id: this.budget.id,
	name_short: this.budget.name_short,
	name: this.budget.name,
	type_id: this.budget.type_id,
});
...
<template>
	...
	<AuthenticatedLayout>
		<template #header>
			<h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Create budget</h2>
		</template>
